...
data class AdminUpdateMetaRequest(
    ...
    @SerialName(value = "sensitiveMediaDetectionSensitivity") val sensitiveMediaDetectionSensitivity: AdminUpdateMetaRequest.SensitiveMediaDetectionSensitivity? = null,
