...
data class MeDetailed(
    ...
    @SerialName(value = "onlineStatus") @Required val onlineStatus: MeDetailed.OnlineStatus?,
    ...
    @SerialName(value = "twoFactorBackupCodes") @Required val twoFactorBackupCodes: MeDetailed.TwoFactorBackupCodes,
