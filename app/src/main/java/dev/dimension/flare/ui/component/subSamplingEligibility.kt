...
context(Resolver)
private suspend fun AssetImageSource.canBeSubSampled(): Boolean = canBeSubSampled(peek(request.context).source())

context(Resolver)
@SuppressLint("Recycle")
private suspend fun UriImageSource.canBeSubSampled(): Boolean = canBeSubSampled(peek(request.context).source())
