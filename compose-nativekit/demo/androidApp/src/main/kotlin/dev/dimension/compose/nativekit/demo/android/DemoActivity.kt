package dev.dimension.compose.nativekit.demo.android

import android.content.Context
import android.content.Intent
import android.os.Bundle
import androidx.fragment.app.FragmentActivity
import dev.dimension.compose.nativekit.demo.createAndroidComposeDemoView
import dev.dimension.compose.nativekit.demo.createAndroidViewDemoView
...
public class DemoActivity : FragmentActivity() {
    ...
    public companion object {
        internal const val EXTRA_BACKEND: String =
            "dev.dimension.compose.nativekit.demo.android.extra.BACKEND"
