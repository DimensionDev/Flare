...
public class NativeKitDemoComposeResourcesTest {
    @get:Rule
    ...
    public fun rendersAndUpdatesGeneratedResources() {
        ...
        composeRule.onNodeWithTag("demo-catalog-title").assertTextEquals("Compose NativeKit Catalog")
        composeRule
            .onNodeWithTag("demo-catalog-image")
            .assertContentDescriptionEquals("NativeKit resource image")
            .assertWidthIsEqualTo(64.dp)
            .assertHeightIsEqualTo(64.dp)
        composeRule.onNodeWithTag("demo-open-resources").performClick()

        composeRule.onNodeWithTag("demo-image").assertContentDescriptionEquals("NativeKit resource image")
        composeRule
