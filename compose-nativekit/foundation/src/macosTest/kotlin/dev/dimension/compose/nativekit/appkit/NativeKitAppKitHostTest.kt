...
import dev.dimension.compose.nativekit.awaitAppleUi
...
public class NativeKitAppKitHostTest {
    @Test
    public fun hostRecomposesAndRecreatesContentAcrossWindowAttachment() {
        ...
        val host = NativeKitAppKitHost(createAppKitWidgetSystem())
    ...
    private fun NativeKitAppKitHost.awaitColumn(): NSStackView {
