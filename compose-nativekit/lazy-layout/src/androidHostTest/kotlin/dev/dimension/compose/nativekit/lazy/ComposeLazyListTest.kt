                ...
                NativeKitComposeHost(
                    ...
                    LazyColumn(modifier = NativeKitModifier.None.fillMaxSize(), state = state) {
                        items(
                            ...
                            Text(
                                text = "Item $index",
                                modifier = NativeKitModifier(testTag = "custom-key-item-$index"),
                            )
                        }
                    }
                }
                ...
                NativeKitComposeHost(
                    ...
                    LazyColumn(modifier = NativeKitModifier.None.fillMaxSize()) {
                        items(
                            ...
                            Text(
                                text = "Item $index",
                                modifier = NativeKitModifier(testTag = "item-$index"),
                            )
                        }
                    }
                }
        ...
        composeRule.setContent {
            MaterialTheme {
                NativeKitComposeHost(
                    ...
                    LazyColumn(modifier = NativeKitModifier.None.fillMaxSize()) {
                        item(key = "stable") {
                            Text(labelSnapshot, modifier = NativeKitModifier(testTag = "stable-item"))
                        }
                    }
                }
            }
                ...
                NativeKitComposeHost(
                    ...
                    LazyRow(modifier = NativeKitModifier.None.fillMaxSize()) {
                        items(
                            ...
                            Text(
                                text = "Item $index",
                                modifier = NativeKitModifier(testTag = "row-item-$index"),
                            )
                        }
                    }
                }
                ...
                NativeKitComposeHost(
                    ...
                    LazyColumn(modifier = NativeKitModifier.None.fillMaxSize()) {
                        item(key = "multiple") {
                            Text(
                                text = "First",
                                modifier = NativeKitModifier(testTag = "first").height(24f),
                            )
                            Text(
                                text = "Second",
                                modifier = NativeKitModifier(testTag = "second").height(36f),
                            )
                        }
                    }
                }
        ...
        composeRule.setContent {
            MaterialTheme {
                NativeKitComposeHost(
                    ...
                    LazyRow(
                        modifier = NativeKitModifier(testTag = "geometry-row").width(200f).height(80f),
                        spacing = 6f,
                        ...
                        item(key = "first") {
                            Text(
                                "First",
                                modifier = NativeKitModifier(testTag = "geometry-first").width(40f).height(24f),
                            )
                        }
                        item(key = "second") {
                            Text(
                                "Second",
                                modifier = NativeKitModifier(testTag = "geometry-second").width(60f).height(24f),
                            )
                        }
                    }
                }
            ...
            MaterialTheme {
                NativeKitComposeHost(
                    ...
                    LazyColumn(
                        ...
                        item(key = "first") {
                            Text("First", modifier = NativeKitModifier(testTag = "stretch-first").height(32f))
                        }
        ...
        composeRule.setContent {
            ...
            MaterialTheme {
                NativeKitComposeHost(
                    ...
                    LazyColumn(
                        modifier = NativeKitModifier.None.width(200f).height(240f),
                        state = state,
                        spacing = 6f,
                    ) {
                        items(
                            ...
                            Text(
                                "Item $value",
                                modifier =
                                    NativeKitModifier(testTag = "variable-item-$value")
                ...
                NativeKitComposeHost(
                    ...
                    LazyColumn(
                        ...
                        items(count = 1_000, key = { it }) { index ->
                            Text(
                                text = "Item $index",
                                modifier = NativeKitModifier(testTag = "scroll-item-$index").height(40f),
                            )
                        }
                    }
                }
