...
import dev.dimension.compose.nativekit.lazy.LazyCollectionCoordinator
...
import dev.dimension.compose.nativekit.lazy.LazyItemHost
import dev.dimension.compose.nativekit.lazy.LazyListItemInfo
import dev.dimension.compose.nativekit.lazy.LazyListLayoutInfo
import dev.dimension.compose.nativekit.lazy.LazyListOrientation
import dev.dimension.compose.nativekit.lazy.LazyListScrollRequest
import dev.dimension.compose.nativekit.lazy.LazyRealizedItemUpdate
import dev.dimension.compose.nativekit.lazy.R
import dev.dimension.compose.nativekit.lazy.findIndexByKey
import kotlinx.coroutines.Dispatchers
import kotlin.math.roundToInt

/** RecyclerView renderer for NativeKit lazy collections. */
public object AndroidViewLazyLayoutRendererPlugin : NativeKitRendererPlugin<AndroidViewBackend> {
...
private class AndroidViewLazyCollectionWidget(
    backend: AndroidViewBackend,
        ...
        LayoutInflater
            ...
            .inflate(R.layout.nativekit_lazy_recycler_view, null, false) as RecyclerView,
    ),
...
private class AndroidLazyAdapter(
    ...
    // bucket per type; the NativeKit item host already resets composition content when it is rebound.
