...
internal class LazyCollectionCoordinator(
    ...
    fun createItemHost(root: NativeKitChildren): LazyItemHost {
...
internal class LazyItemHost(
    ...
    private var composition: NativeKitSubcomposition? = null
    private var compositionFactory: NativeKitSubcompositionFactory? = null
    ...
    private fun hostedContent(): NativeKitContent =
        {
    ...
    internal fun bind(
        ...
        val nextContent: NativeKitContent = {
            composeKey(nextKey) {
                provider.Item(index)
            }
        }
