...
public typealias LazyIndexedContent = @Composable @NativeKitComposable (index: Int) -> Unit

public typealias LazyItemContent<T> = @Composable @NativeKitComposable (item: T) -> Unit

public typealias LazyIndexedItemContent<T> = @Composable @NativeKitComposable (index: Int, item: T) -> Unit
