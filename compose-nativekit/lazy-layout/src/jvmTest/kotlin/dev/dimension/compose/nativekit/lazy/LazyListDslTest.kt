...
class LazyListDslTest {
    ...
    fun rebindingTheSameItemInTheSameModelKeepsItsComposition() {
        ...
        val factory =
            object : NativeKitSubcompositionFactory {
                override fun create(root: NativeKitChildren): NativeKitSubcomposition =
                    object : NativeKitSubcomposition {
...
private data object NoOpSubcompositions : NativeKitSubcompositionFactory {
    override fun create(root: NativeKitChildren): NativeKitSubcomposition =
        object : NativeKitSubcomposition {
...
private fun testWidgetSystem(widget: RecordingLazyCollectionWidget): NativeKitWidgetSystem<TestBackend> =
...
private class HeadlessTestHost(
    ...
    widgetSystem: NativeKitWidgetSystem<TestBackend>,
) : AutoCloseable {
    ...
    private val composition = NativeKitComposition(root, widgetSystem, TestBackend, recomposer)
