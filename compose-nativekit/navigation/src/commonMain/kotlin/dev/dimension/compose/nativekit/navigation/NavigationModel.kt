...
internal class NavigationModel(
    ...
    val subcompositions: NativeKitSubcompositionFactory,
    val nativeControllerOwner: NativeKitNativeControllerOwner? = null,
)

/** Renderer seam implemented by the platform navigation adapters. */
internal interface NavigationWidget : NativeKitWidget {
