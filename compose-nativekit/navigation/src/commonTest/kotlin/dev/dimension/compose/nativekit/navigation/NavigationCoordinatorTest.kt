...
private object UnusedSubcompositionFactory : NativeKitSubcompositionFactory {
    override fun create(root: NativeKitChildren): NativeKitSubcomposition = error("Coordinator tests never realize entry content.")
}
