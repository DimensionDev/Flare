...
import dev.dimension.compose.nativekit.uikit.UIKitChildren
 ...
 *
 * Pass this owner to [dev.dimension.compose.nativekit.uikit.NativeKitUIKitHost]. The navigation renderer adds
...
public object UIKitNavigationRendererPlugin : NativeKitRendererPlugin<UIKitBackend> {
            ...
            model.nativeControllerOwner as? UIKitNavigationOwner
                ?: error(
                    "UIKitNavigationRendererPlugin requires UIKitNavigationOwner. Pass " +
                        "UIKitNavigationOwner(parentViewController) to NativeKitUIKitHost.",
                )
        ...
        navigationController.viewControllers.map { controller ->
            val entryController =
                controller as? UIKitNavigationEntryController
                    ?: error("UIKit navigation stack contains a controller not owned by NativeKit navigation.")
