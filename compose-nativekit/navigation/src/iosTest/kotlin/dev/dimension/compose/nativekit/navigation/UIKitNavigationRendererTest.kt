...
public class UIKitNavigationRendererTest {
    ...
    public fun pageControllerUsesTheDynamicSystemBackground() {
        ...
        val host =
            NativeKitUIKitHost(
                widgetSystem = NativeKitWidgetSystem<UIKitBackend>(UIKitNavigationRendererPlugin),
                nativeControllerOwner = UIKitNavigationOwner(parent),
            )
...
private class UIKitNavigationFixture(
    ...
    private var currentSubcompositions: NativeKitSubcompositionFactory = subcompositions
    ...
    fun dispatch(
        ...
        subcompositions: NativeKitSubcompositionFactory = currentSubcompositions,
    ) {
...
private class UIKitRecordingSubcompositionFactory : NativeKitSubcompositionFactory {
...
private interface WrapHeightLabelWidget : NativeKitWidget

@Composable
@NativeKitComposable
private fun WrapHeightLabel() {
    EmitNativeKitWidget(componentType = WrapHeightLabelWidget::class)
}

private val wrapHeightLabelPlugin =
    object : NativeKitRendererPlugin<UIKitBackend> {
