...
import dev.dimension.compose.nativekit.navigation.NAVIGATION_ACKNOWLEDGEMENT_TIMEOUT_MILLIS
import dev.dimension.compose.nativekit.navigation.NavigationAcknowledgementHandle
import dev.dimension.compose.nativekit.navigation.NavigationCommand
import dev.dimension.compose.nativekit.navigation.NavigationCoordinator
import dev.dimension.compose.nativekit.navigation.NavigationCoordinatorState
import dev.dimension.compose.nativekit.navigation.NavigationEntryContentHost
import dev.dimension.compose.nativekit.navigation.NavigationEntryIdentity
import dev.dimension.compose.nativekit.navigation.NavigationInteractionHandle
import dev.dimension.compose.nativekit.navigation.NavigationModel
import dev.dimension.compose.nativekit.navigation.NavigationModelDispatcher
import dev.dimension.compose.nativekit.navigation.NavigationOperation
import dev.dimension.compose.nativekit.navigation.NavigationOperationResult
import dev.dimension.compose.nativekit.navigation.NavigationPresentation
import dev.dimension.compose.nativekit.navigation.NavigationWidget
import dev.dimension.compose.nativekit.navigation.ResolvedNavigationEntry
import dev.dimension.compose.nativekit.navigation.identity
...
/**
 * Supplies an AppKit controller to [NavigationDisplay][dev.dimension.compose.nativekit.navigation.NavigationDisplay].
 *
...
/** AppKit renderer plugin for Page-only NativeKit Navigation. */
public object AppKitNavigationRendererPlugin : NativeKitRendererPlugin<AppKitBackend> {
...
internal class AppKitNavigationWidget(
    ...
    private var subcompositions: NativeKitSubcompositionFactory? = null
    ...
    private fun requireSubcompositions(): NativeKitSubcompositionFactory =
        ...
        container.childViewControllers.map { controller ->
            val entryController =
                controller as? AppKitNavigationEntryController
                    ?: error("AppKit navigation container contains a controller not owned by NativeKit navigation.")
...
internal class AppKitNavigationEntryController(
    ...
    private var subcompositions: NativeKitSubcompositionFactory,
    ...
    fun update(
        ...
        subcompositions: NativeKitSubcompositionFactory = this.subcompositions,
    ) {
