...
internal abstract class RuntimeNode {
    ...
    protected abstract val target: NativeKitChildren
    ...
    open fun prepareInsert(
        ...
        require(instance is WidgetRuntimeNode) {
            "A NativeKit container can contain only primitive widgets."
        }
...
internal class RootRuntimeNode(
    override val target: NativeKitChildren,
) : RuntimeNode() {
    fun onBeginChanges() {
...
internal class WidgetRuntimeNode(
    ...
    fun setModifier(modifier: NativeKitModifier) {
