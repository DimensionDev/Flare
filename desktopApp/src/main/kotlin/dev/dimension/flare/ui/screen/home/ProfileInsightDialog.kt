    ...
    FluentDialog(
        ...
        Column(
            ...
            AgentChatScaffold(
                ...
                error = state.error,
                runningTrace = state.currentTrace?.label() ?: stringResource(Res.string.profile_insight_analyzing),
                ...
                messageText = ProfileInsightPresenter.Message::text,
                messageLocalizedText = ProfileInsightPresenter.Message::localizedText,
                messageParts = ProfileInsightPresenter.Message::parts,
                messageInputRequest = ProfileInsightPresenter.Message::inputRequest,
                messageInputRequestSelected = ProfileInsightPresenter.Message::inputRequestSelected,
                messageInputRequestSelectedOptionId = ProfileInsightPresenter.Message::inputRequestSelectedOptionId,
                isUserMessage = { it is ProfileInsightPresenter.Message.User },
