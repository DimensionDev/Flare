...
class PerformanceTestConfig {
    ...
    enum TestScenario: String, CaseIterable {
        ...
        var description: String {
            ...
            case .stableIDOnly:
                return "Stable ID system only"
            case .stableIDAndStateOpt:
                return "Stable ID + State observation optimization"
            case .allOptimizations:
                return "All optimizations enabled"
            }
        }
    }
    ...
    enum TestPhase: String, CaseIterable {
        ...
        var description: String {
            ...
            case .idle:
                return "Idle state"
            case .staticTest:
                return "Static test (no scrolling)"
            case .slowScroll:
                return "Slow scrolling test"
            case .fastScroll:
                return "Fast scrolling test"
            case .continuousScroll:
                return "Continuous scrolling test"
            }
        }
    }
