...
struct BlueskyNotificationComponent: View {
    ...
    var body: some View {
        VStack {
            ...
            case .repost:
                StatusRetweetHeaderComponent(iconSystemName: "arrow.left.arrow.right", nameMarkdown: data.user.extra.nameMarkdown, text: "repost your post")
            case .quote:
                StatusRetweetHeaderComponent(iconSystemName: "arrowshape.turn.up.left", nameMarkdown: data.user.extra.nameMarkdown, text: "quoted your post")
            case .like:
                StatusRetweetHeaderComponent(iconSystemName: "star", nameMarkdown: data.user.extra.nameMarkdown, text: "like your note")
            }
            HStack {
