...
open class JXPagingListRefreshView: JXPagingView {
    ...
    override public init(delegate: JXPagingViewDelegate, listContainerType: JXPagingListContainerType = .collectionView) {
    ...
    override open func preferredProcessListViewDidScroll(scrollView _: UIScrollView) {
        guard let currentScrollingListView else { return }
