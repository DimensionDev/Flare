...
private struct PagingViewRepresentable<Content: View>: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context _: Context) -> PagingViewController<Content> {
    ...
    func updateUIViewController(_ uiViewController: PagingViewController<Content>, context _: Context) {
...
private class PagingViewController<Content: View>: UIViewController, JXPagingViewDelegate {
    ...
    func heightForPinSectionHeader(in _: JXPagingView) -> Int {
        Int(pinnedVC.view.systemLayoutSizeFitting(UIView.layoutFittingCompressedSize).height)
    }
    ...
    func pagingView(_: JXPagingView, initListAtIndex _: Int) -> JXPagingViewListViewDelegate {
        listContainerVC
    }
