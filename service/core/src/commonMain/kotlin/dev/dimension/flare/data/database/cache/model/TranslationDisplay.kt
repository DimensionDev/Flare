            ...
            run {
                ...
                val menuAction =
                    when {
                        ...
                        canRetrySkippedManually(translation) -> TranslationMenuAction.Translate
...
private fun canRetrySkippedManually(existing: DbTranslation?): Boolean =
    existing?.status == TranslationStatus.Skipped &&
        existing.statusReason == "source_language_excluded"
