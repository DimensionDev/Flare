        ...
        coroutineScope.launch {
            val originalData =
                database
                    ...
                    ?.content
            val nextActionMenu = mutation.nextActionMenu()
            ...
            if (mutation.type == StatusMutation.TYPE_VOTE && originalData is UiTimelineV2.Post) {
                val options =
                ...
                if (poll != null && options.isNotEmpty()) {
                    val updatedData =
                        originalData.copy(
                            poll =
                                poll.copy(
                                    ownVotes = options.toImmutableList(),
                                    options =
                                        poll.options
