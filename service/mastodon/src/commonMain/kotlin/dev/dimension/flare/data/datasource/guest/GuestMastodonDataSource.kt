...
public class GuestMastodonDataSource(
    ...
    override fun searchUser(query: String): RemoteLoader<UiProfile> =
        SearchUserPagingSource(
            search = { value, maxId, limit, type, _, _ ->
                service.searchV2(query = value, type = type, limit = limit, max_id = maxId).accounts ?: emptyList()
            },
            host = host,
            accountKey = null,
            query = query,
