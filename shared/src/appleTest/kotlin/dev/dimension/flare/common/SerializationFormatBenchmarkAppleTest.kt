...
class SerializationFormatBenchmarkAppleTest {
    @BeforeTest
    fun setUp() {
        startKoin {
            modules(
    ...
    @Test
    fun compareJsonAndProtoBufForStoredTimelinePayloadOnApple() =
        runTest {
            val warmupIterations = DEFAULT_WARMUP_ITERATIONS
            val benchmarkIterations = DEFAULT_BENCHMARK_ITERATIONS
            ...
            println(
                buildString {
                    appendLine("Serialization benchmark (Apple)")
    ...
    private fun Double.formatMicros(): String {
    ...
    private companion object {
        const val DEFAULT_WARMUP_ITERATIONS = 200
        const val DEFAULT_BENCHMARK_ITERATIONS = 1_000
    }
}
