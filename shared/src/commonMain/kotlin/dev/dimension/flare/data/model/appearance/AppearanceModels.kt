...
public data class GlobalAppearance(
    ...
    val showPostInMediaViewer: Boolean = AppearanceKeys.ShowPostInMediaViewer.default,
) {
...
public data class TimelineAppearance(
    ...
    val showEmojiReactions: Boolean = AppearanceKeys.ShowEmojiReactions.default,
...
public fun AppearancePatch.toGlobalAppearance(): GlobalAppearance =
    GlobalAppearance(
        ...
        showPostInMediaViewer = get(AppearanceKeys.ShowPostInMediaViewer),
    )
...
public fun AppearancePatch.toTimelineAppearance(override: AppearancePatch?): TimelineAppearance =
    TimelineAppearance(
        ...
        showEmojiReactions = getTimelineValue(AppearanceKeys.ShowEmojiReactions, override),
...
public fun TimelineAppearance.withPatch(patch: AppearancePatch?): TimelineAppearance {
    ...
    return copy(
        ...
        showEmojiReactions = patch.getTimelineValue(AppearanceKeys.ShowEmojiReactions, showEmojiReactions),
