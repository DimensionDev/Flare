...
internal interface TweetApi {
    ...
    suspend fun getSearchTimeline(
        @Path("pathQueryId") pathQueryId: kotlin.String = "3Ej-6N7xXONuEp5eJa1TdQ",
        @Query(
            "variables",
    ...
    suspend fun getTweetDetail(
        @Path("pathQueryId") pathQueryId: kotlin.String = "xOhkmRac04YFZmOzU9PJHg",
        @Query(
            "variables",
        ...
        @Query("fieldToggles") fieldToggles: kotlin.String = "{\"withArticleRichContentState\": false}",
     ...
     *  - 200: Successful operation
     *
     * @param pathQueryId  (default to "Q6aAvPw7azXZbqXzuqTALA")
    ...
    suspend fun getUserTweetsAndReplies(
        @Path("pathQueryId") pathQueryId: kotlin.String = "Q6aAvPw7azXZbqXzuqTALA",
        @Query(
            "variables",
