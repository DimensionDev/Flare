 ...
 */
@Serializable
enum class ContentEntryType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is ContentEntryType) "$data" else null

        /**
         * Returns a valid [ContentEntryType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): ContentEntryType? =
            data?.let {
