        ...
        actions =
            listOfNotNull(
                    ...
                    actions =
                        listOfNotNull(
                            ActionMenu.repost(
                                statusKey = statusKey,
                                accountKey = accountKey,
                                toggled = viewer?.repost?.atUri != null,
                                count = repostCount ?: 0,
                                extras =
                                    buildMap {
                                        put("cid", cid.cid)
                                        put("uri", uri.atUri)
                                        viewer?.repost?.atUri?.let { put("repost_uri", it) }
                                    },
                            ),
                            ActionMenu.Item(
                                icon = UiIcon.Quote,
                ...
                ActionMenu.like(
                    statusKey = statusKey,
                    accountKey = accountKey,
                    toggled = viewer?.like?.atUri != null,
                    count = likeCount ?: 0,
                    extras =
                        buildMap {
                            put("cid", cid.cid)
                            put("uri", uri.atUri)
                            viewer?.like?.atUri?.let { put("liked_uri", it) }
                        },
                ),
                ActionMenu.Group(
                    displayItem =
                        ...
                        buildList {
                            add(
                                ActionMenu.bookmark(
                                    statusKey = statusKey,
                                    accountKey = accountKey,
                                    toggled = viewer?.bookmarked == true,
                            ...
                            actions =
                                listOfNotNull(
                                    ActionMenu.repost(
                                        ...
                                        extras =
                                            buildMap {
                                                put("cid", record.value.cid.cid)
                                                put("uri", record.value.uri.atUri)
                                            },
                                    ),
                                    ActionMenu.Item(
                                        icon = UiIcon.Quote,
