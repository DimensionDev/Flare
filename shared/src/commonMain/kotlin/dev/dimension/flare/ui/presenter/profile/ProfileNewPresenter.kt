...
public class ProfileNewPresenter(
    private val accountType: AccountType,
    private val userKey: MicroBlogKey?,
) : PresenterBase<ProfileNewState>(),
    KoinComponent {
    private val accountRepository: AccountRepository by inject()

    @Composable
    override fun body(): ProfileNewState {
...
@Immutable
public abstract class ProfileNewState(
