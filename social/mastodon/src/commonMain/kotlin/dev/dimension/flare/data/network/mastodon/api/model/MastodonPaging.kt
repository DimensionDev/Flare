...
public class MastodonPaging<T>(
    private val data: List<T>,
    public val next: String? = null,
    public val prev: String? = null,
) : List<T> by data {
    public operator fun plus(other: List<T>): MastodonPaging<T> =
        MastodonPaging(
...
public class MastodonPagingConverterFactory : Converter.Factory {
    @OptIn(InternalAPI::class)
    public override fun suspendResponseConverter(
        typeData: TypeData,
        ktorfit: Ktorfit,
