...
public interface DefaultApi {
    ...
    public suspend fun adminAbuseReportResolverDelete(
    ...
    public suspend fun adminAbuseReportResolverList(
    ...
    public suspend fun adminAbuseReportResolverUpdate(
    ...
    public suspend fun iClaimAchievement(
    ...
    public suspend fun usersAchievements(
    ...
    public suspend fun usersListsCreateFromPublic(
    ...
    public suspend fun usersListsFavorite(
    ...
    public suspend fun usersListsUnfavorite(
        @Body usersListsDeleteRequest: UsersListsDeleteRequest,
    ): Unit
}
