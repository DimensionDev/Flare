...
public interface FederationApi {
    ...
    public suspend fun federationFollowing(
        @Body federationFollowersRequest: FederationFollowersRequest,
    ): kotlin.collections.List<Following>
    ...
    public suspend fun federationInstances(
    ...
    public suspend fun federationShowInstance(
    ...
    public suspend fun federationStats(
    ...
    public suspend fun federationUpdateRemoteUser(
    ...
    public suspend fun federationUsers(
        @Body federationFollowersRequest: FederationFollowersRequest,
