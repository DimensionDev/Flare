...
public interface HashtagsApi {
    ...
    public suspend fun hashtagsSearch(
     ...
     */
    @POST("hashtags/show")
    public suspend fun hashtagsShow(
     ...
     */
    @GET("hashtags/trend")
    public suspend fun hashtagsTrend(): kotlin.collections.List<HashtagsTrend200ResponseInner>
