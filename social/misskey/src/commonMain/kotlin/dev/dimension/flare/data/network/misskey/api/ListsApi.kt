...
public interface ListsApi {
    ...
    public suspend fun usersListsCreate(
    ...
    public suspend fun usersListsDelete(
    ...
    public suspend fun usersListsList(
    ...
    public suspend fun usersListsPull(
    ...
    public suspend fun usersListsShow(
