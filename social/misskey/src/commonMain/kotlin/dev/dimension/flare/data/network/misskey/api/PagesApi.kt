...
public interface PagesApi {
     ...
     */
    @POST("pages/create")
    public suspend fun pagesCreate(
     ...
     */
    @POST("pages/delete")
    public suspend fun pagesDelete(
     ...
     */
    @POST("pages/featured")
    public suspend fun pagesFeatured(
     ...
     */
    @POST("pages/unlike")
    public suspend fun pagesUnlike(
        @Body pagesDeleteRequest: PagesDeleteRequest,
    ): Unit
     ...
     */
    @POST("pages/update")
    public suspend fun pagesUpdate(
