...
public interface WebhooksApi {
    ...
    public suspend fun iWebhooksCreate(
    ...
    public suspend fun iWebhooksDelete(
    ...
    public suspend fun iWebhooksList(
    ...
    public suspend fun iWebhooksShow(
        @Body iwebhooksShowRequest: IWebhooksShowRequest,
    ): Unit
    ...
    public suspend fun iWebhooksUpdate(
