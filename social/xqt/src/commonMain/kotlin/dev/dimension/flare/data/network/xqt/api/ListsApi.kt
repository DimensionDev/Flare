...
public interface ListsApi {
    ...
    public suspend fun getListsManagementPageTimeline(
    ...
    public suspend fun editListBanner(
    ...
    public suspend fun getListOwnerships(
    ...
    public suspend fun getListMembers(
    ...
    public suspend fun getListByRestId(
