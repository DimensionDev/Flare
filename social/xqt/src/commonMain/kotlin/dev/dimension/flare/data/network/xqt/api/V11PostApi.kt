...
public interface V11PostApi {
    ...
    public suspend fun postCreateFriendships(
    ...
    public suspend fun postDestroyFriendships(
        @Field("include_blocked_by") includeBlockedBy: kotlin.Int = 1,
        @Field("include_blocking") includeBlocking: kotlin.Int = 1,
        @Field("include_can_dm") includeCanDm: kotlin.Int = 1,
        @Field("include_can_media_tag") includeCanMediaTag: kotlin.Int = 1,
    ...
    public suspend fun postMutesUsersCreate(
        @Field("user_id") userId: kotlin.String = "44196397",
    ): Response<Unit>

    @FormUrlEncoded
    @POST("1.1/mutes/users/destroy.json")
    public suspend fun postMutesUsersDestroy(
        @Field("user_id") userId: kotlin.String = "44196397",
    ): Response<Unit>

    @FormUrlEncoded
    @POST("1.1/blocks/create.json")
    public suspend fun postBlocksCreate(
        @Field("user_id") userId: kotlin.String = "44196397",
    ): Response<Unit>

    @FormUrlEncoded
    @POST("1.1/blocks/destroy.json")
    public suspend fun postBlocksDestroy(
        @Field("user_id") userId: kotlin.String = "44196397",
    ): Response<Unit>

    @POST("1.1/media/metadata/create.json")
    public suspend fun postMediaMetadataCreate(
    ...
    public suspend fun postDMWelcomeMessagesAddToConversation(
