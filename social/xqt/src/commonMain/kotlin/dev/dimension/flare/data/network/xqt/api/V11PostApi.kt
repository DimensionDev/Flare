...
internal interface V11PostApi {
    ...
    @FormUrlEncoded
    @POST("1.1/friendships/create.json")
    suspend fun postCreateFriendships(@Field("include_blocked_by") includeBlockedBy: kotlin.Int = 1, @Field("include_blocking") includeBlocking: kotlin.Int = 1, @Field("include_can_dm") includeCanDm: kotlin.Int = 1, @Field("include_can_media_tag") includeCanMediaTag: kotlin.Int = 1, @Field("include_ext_has_nft_avatar") includeExtHasNftAvatar: kotlin.Int = 1, @Field("include_ext_is_blue_verified") includeExtIsBlueVerified: kotlin.Int = 1, @Field("include_ext_profile_image_shape") includeExtProfileImageShape: kotlin.Int = 1, @Field("include_ext_verified_type") includeExtVerifiedType: kotlin.Int = 1, @Field("include_followed_by") includeFollowedBy: kotlin.Int = 1, @Field("include_mute_edge") includeMuteEdge: kotlin.Int = 1, @Field("include_profile_interstitial_type") includeProfileInterstitialType: kotlin.Int = 1, @Field("include_want_retweets") includeWantRetweets: kotlin.Int = 1, @Field("skip_status") skipStatus: kotlin.Int = 1, @Field("user_id") userId: kotlin.String = "44196397"): Response<Unit>
    ...
    @FormUrlEncoded
    @POST("1.1/friendships/destroy.json")
    suspend fun postDestroyFriendships(@Field("include_blocked_by") includeBlockedBy: kotlin.Int = 1, @Field("include_blocking") includeBlocking: kotlin.Int = 1, @Field("include_can_dm") includeCanDm: kotlin.Int = 1, @Field("include_can_media_tag") includeCanMediaTag: kotlin.Int = 1, @Field("include_ext_has_nft_avatar") includeExtHasNftAvatar: kotlin.Int = 1, @Field("include_ext_is_blue_verified") includeExtIsBlueVerified: kotlin.Int = 1, @Field("include_ext_profile_image_shape") includeExtProfileImageShape: kotlin.Int = 1, @Field("include_ext_verified_type") includeExtVerifiedType: kotlin.Int = 1, @Field("include_followed_by") includeFollowedBy: kotlin.Int = 1, @Field("include_mute_edge") includeMuteEdge: kotlin.Int = 1, @Field("include_profile_interstitial_type") includeProfileInterstitialType: kotlin.Int = 1, @Field("include_want_retweets") includeWantRetweets: kotlin.Int = 1, @Field("skip_status") skipStatus: kotlin.Int = 1, @Field("user_id") userId: kotlin.String = "44196397"): Response<Unit>
