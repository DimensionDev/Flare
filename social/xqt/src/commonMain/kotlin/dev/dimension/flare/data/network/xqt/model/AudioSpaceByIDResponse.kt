...
@Serializable
public data class AudioSpaceByIDResponse(
    val data: Data? = null,
)
...
public typealias RResults = UserResults
...
@Serializable
public data class MetadataTweetResults(
    val result: PurpleResult? = null,
)

@Serializable
public data class PurpleResult(
...
@Serializable
public data class BindingValue(
    val key: String? = null,
...
@Serializable
public data class CardPlatform(
...
@Serializable
public data class FluffyLegacy(
...
@Serializable
public data class AudioUserResults(
    @SerialName("rest_id")
    val restID: String? = null,
...
@Serializable
public data class FluffyResult(
    @SerialName("__typename")
    val typename: String? = null,
...
@Serializable
public data class SharedItemTweetResults(
    val result: TentacledResult? = null,
)

@Serializable
public data class TentacledResult(
    @SerialName("__typename")
    val typename: String? = null,
    @SerialName("rest_id")
    val restID: String? = null,
...
@Serializable
public data class TentacledLegacy(
    @SerialName("bookmark_count")
    val bookmarkCount: Long? = null,
    val bookmarked: Boolean? = null,
    @SerialName("created_at")
...
@Serializable
public data class QuotedStatusPermalink(
    val url: String? = null,
...
@Serializable
public data class QuotedStatusResult(
    val result: QuotedStatusResultResult? = null,
)

@Serializable
public data class QuotedStatusResultResult(
    @SerialName("__typename")
    val typename: String? = null,
    @SerialName("rest_id")
    val restID: String? = null,
...
@Serializable
public data class StickyLegacy(
    @SerialName("bookmark_count")
    val bookmarkCount: Long? = null,
    val bookmarked: Boolean? = null,
    @SerialName("created_at")
