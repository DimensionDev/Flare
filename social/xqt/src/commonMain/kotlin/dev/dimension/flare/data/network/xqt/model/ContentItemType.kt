 ...
 */
@Serializable
public enum class ContentItemType(
    ...
    public companion object {
         ...
         */
        public fun encode(data: kotlin.Any?): kotlin.String? = if (data is ContentItemType) "$data" else null

        /**
         * Returns a valid [ContentItemType] for [data], null otherwise.
         */
        public fun decode(data: kotlin.Any?): ContentItemType? =
            data?.let {
