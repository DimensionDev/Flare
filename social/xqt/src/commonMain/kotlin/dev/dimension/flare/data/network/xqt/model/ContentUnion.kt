...
public class SafeContentUnionSerializer : KSerializer<ContentUnion?> {
    ...
    public override fun deserialize(decoder: Decoder): ContentUnion? = safeSerializer.deserialize(decoder)
}
