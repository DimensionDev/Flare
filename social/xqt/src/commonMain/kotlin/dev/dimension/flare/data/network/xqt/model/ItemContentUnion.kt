...
public sealed interface ItemContentUnion {
//    @Contextual
...
public class SafeItemContentSerializer : KSerializer<ItemContentUnion?> {
    private val safeSerializer = SafePolymorphicSerializer(ItemContentUnion.serializer(), "__typename")

    public override val descriptor: SerialDescriptor = safeSerializer.descriptor
    ...
    public override fun deserialize(decoder: Decoder): ItemContentUnion? = safeSerializer.deserialize(decoder)
}
