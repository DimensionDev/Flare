 ...
 */
@Serializable
public data class PostCreateTweetRequest(
...
@Serializable
public data class CreateBookmarkRequest(
...
@Serializable
public data class CreateBookmarkRequestVariables(
    @SerialName("tweet_id")
    val tweetId: String,
...
@Serializable
public data class CreateBookmark200Response(
    @SerialName("data")
    val data: CreateBookmark200ResponseData,
)

@Serializable
public data class CreateBookmark200ResponseData(
    @SerialName("tweet_bookmark_put")
    val tweet_bookmark_put: String,
)

@Serializable
public data class DeleteBookmarkRequest(
    @SerialName("variables")
...
@Serializable
public data class DeleteBookmarkRequestVariables(
    @SerialName("tweet_id")
    val tweetId: String,
    @SerialName("darkRequest")
    val darkRequest: Boolean = false,
...
@Serializable
public data class DeleteBookmark200Response(
    @SerialName("data")
    val data: DeleteBookmark200ResponseData,
)

@Serializable
public data class DeleteBookmark200ResponseData(
