...
@Serializable
public data class ListsMembershipsResponse(
    @SerialName("lists")
...
@Serializable
public data class RemoveListResponse(
    @SerialName("data")
    val data: RemoveListResponseData? = null,
)

@Serializable
public data class RemoveListResponseData(
    @SerialName("list_delete")
    val listDelete: String? = null,
)

@Serializable
public data class RemoveListRequest(
    val variables: Variables,
    @SerialName("queryId")
...
@Serializable
public data class ListsOwnerships200Response(
    @SerialName("data")
    val data: ListsOwnerships200ResponseData? = null,
)

@Serializable
public data class ListsOwnerships200ResponseData(
    @SerialName("user")
    val user: ListsOwnerships200ResponseUser? = null,
)

@Serializable
public data class ListsOwnerships200ResponseUser(
    @SerialName("result")
    val result: ListsOwnerships200ResponseResult? = null,
)

@Serializable
public data class ListsOwnerships200ResponseResult(
    @SerialName("timeline")
    val timeline: ListsOwnerships200ResponseTimeline? = null,
)

@Serializable
public data class ListsOwnerships200ResponseTimeline(
    @SerialName("timeline")
    val timeline: Timeline? = null,
)

@Serializable
public data class ListsMembers200Response(
    @SerialName("data")
    val data: ListsMembers200ResponseData? = null,
)

@Serializable
public data class ListsMembers200ResponseData(
    @SerialName("list")
    val list: ListsMembers200ResponseList? = null,
)

@Serializable
public data class ListsMembers200ResponseList(
    @SerialName("members_timeline")
    val membersTimeline: ListsMembers200ResponseMembersTimeline? = null,
)

@Serializable
public data class ListsMembers200ResponseMembersTimeline(
    @SerialName("timeline")
    val timeline: Timeline? = null,
)

@Serializable
public data class ListsManagementPageTimeline200Response(
    @SerialName("data")
    val data: ListsManagementPageTimeline200ResponseData? = null,
)

@Serializable
public data class ListsManagementPageTimeline200ResponseData(
    @SerialName("viewer")
    val viewer: ListsManagementPageTimelineViewer? = null,
)

@Serializable
public data class ListsManagementPageTimelineViewer(
    @SerialName("list_management_timeline")
    val listManagementTimeline: ListsManagementPageTimelineListManagementTimeline? = null,
)

@Serializable
public data class ListsManagementPageTimelineListManagementTimeline(
    @SerialName("timeline")
    val timeline: Timeline? = null,
)

@Serializable
public data class CreateListResponse(
    @SerialName("data")
    val data: CreateListResponseData? = null,
)

@Serializable
public data class CreateListResponseData(
    @SerialName("list")
...
@Serializable
public data class RemoveMemberRequest(
    val variables: Variables,
    val features: Features = Features(),
    @SerialName("queryId")
...
@Serializable
public data class EditListBannerRequest(
    val variables: Variables,
    val features: Features = Features(),
    @SerialName("queryId")
...
public data class TimelineTwitterList(
...
@Serializable
public data class DefaultBannerMedia(
...
@Serializable
public data class DefaultBannerMediaResults(
    val result: DefaultBannerMediaResultsResult? = null,
)

@Serializable
public data class DefaultBannerMediaResultsResult(
    val id: String? = null,
