...
@Serializable
public data class TwitterArticleResults(
    val result: TwitterArticleResult? = null,
)

@Serializable
public data class TwitterArticleResult(
...
@Serializable
public data class TwitterArticleBlockData(
    val urls: List<TwitterArticleBlockUrl> = emptyList(),
)

@Serializable
public data class TwitterArticleBlockUrl(
...
@Serializable
public data class TwitterArticleEntityRange(
    val key: Int,
    val length: Int,
    val offset: Int,
)
...
@Serializable
public data class TwitterArticleInlineStyleRange(
    val length: Int,
    val offset: Int,
    val style: String,
)
...
@Serializable
public data class TwitterArticleEntityEntry(
    val key: String? = null,
    public val value: TwitterArticleEntity? = null,
)

@Serializable
public data class TwitterArticleEntity(
...
@Serializable
public data class TwitterArticleEntityData(
...
@Serializable
public data class TwitterArticleMediaItem(
...
@Serializable
public data class TwitterArticleMedia(
    val id: String? = null,
    @SerialName("media_id")
    val mediaId: String? = null,
...
@Serializable
public data class TwitterArticleMediaInfo(
...
@Serializable
public data class TwitterArticlePreviewImage(
    @SerialName("original_img_height")
    val originalImgHeight: Int? = null,
    @SerialName("original_img_url")
    val originalImgUrl: String? = null,
...
@Serializable
public data class TwitterArticleMediaVariant(
    @SerialName("bit_rate")
